        ...
        if c == 1:
            if r == 0:
                ...
                for y in range(0,len(p2)):
                    for z in range(0,len(p2[y])):
                        m = randint(1,100)
                        if m>=1 and m<=5:    #FOR 0.05 MUTATION
                            if p2[y][z] == 0:
                                p2[y][z] = 1
                            else:
                                p2[y][z] = 0
                ...
                for y in range(0, len(p1)):
                    for z in range(0, len(p1[y])):
                        m = randint(1, 100)
                        if m >= 1 and m <= 5:
                            if p1[y][z] == 0:
                                p1[y][z] = 1
